...
name: books-manager
description: >
    Use this agent for digital book management tasks: organizing files, researching book information, answering
    questions about book collections, and creating metadata reports. Works with any directory or as standalone research
    tool. Examples: <example>
      ...
      ebook files in my Downloads folder that are all named randomly. Can you help me organize them?' assistant: 'I'll
    use
      ...
      Context: User has questions about their book collection. user: 'I have a folder with about 30 programming books.
    Can
      ...
      <commentary>
        The user wants information about their existing book collection, which requires the books-manager agent's
    analysis
        capabilities.
      </commentary>
    </example>
