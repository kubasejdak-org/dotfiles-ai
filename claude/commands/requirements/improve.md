...
Use the `requirements` skill (Workflow D) to review and improve the clarity, specificity, and testability of existing
requirements.
...
- `requirements.md FR-3 FR-7 NFR-1` — review a specific subset
